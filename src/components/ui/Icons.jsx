...
export function SettingsIcon() {
  return (
    <svg className="settings-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function WorkoutIcon() {
  return (
    <svg className="bnav-svg" viewBox="0 0 24 24">
